...
const CHARACTERS = [
  { id: "garnet", name: "Garnet", desc: "Too tall. Used to skate daily, now just asking if he can try your coke... again.", color: "#e8c97a", emoji: "🎯", plus: "Everyone loves him. NPCs overshare.", minus: "Becomes Karl in 3 moves. No way back." },
  ...
  { id: "steve", name: "Steve", desc: "Dark soul. Good heart. Bad plans. Frank-O respects him. Stays up 'til 1 billion o'clock.", color: "#60a5fa", emoji: "🥃", plus: "FrankO obeys him. Unlocks the SECRET WIN.", minus: "Intimidates NPCs. Conversations just... end." },
